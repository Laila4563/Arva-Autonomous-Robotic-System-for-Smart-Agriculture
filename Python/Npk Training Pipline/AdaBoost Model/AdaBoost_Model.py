...
def save_metrics_to_csv(history_metrics, train_metrics, test_metrics, model_name):
    ...
    # 3. Save feature importance for AdaBoost
...
joblib.dump(trained_model, 'ada_model.pkl')
print(f"✓ Saved trained model to: ada_model.pkl")

# Save all metrics to CSV files
print("\n" + "="*60)
print("SAVING RESULTS TO CSV FILES:")
print("="*60)
save_metrics_to_csv(history_metrics, train_metrics, test_metrics, 'ada')
