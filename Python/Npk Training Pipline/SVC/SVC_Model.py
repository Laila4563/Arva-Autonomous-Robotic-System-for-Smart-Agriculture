...
# SVC Model
RANDOM_SEED = 42
model_instance = SVC(random_state=RANDOM_SEED, C=10.0, gamma='auto')
...
joblib.dump(trained_model, 'svc_model.pkl')
print(f"✓ Saved trained model to: svc_model.pkl")

# Save all metrics to CSV files
print("\n" + "="*60)
print("SAVING RESULTS TO CSV FILES:")
print("="*60)
save_metrics_to_csv(history_metrics, train_metrics, test_metrics, 'svc')
